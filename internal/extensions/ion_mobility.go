...
func IonMobilityCalculation(parameters *config.ModelParameters, outputDir, modelName string, logger messages.Logger) (dataRow, _ *utils.SheathResult, finalModel, _ *model.Model) {
